#tag WebPage
Begin WebDialog dlg_Indication
   Compatibility   =   ""
   ControlCount    =   0
   ControlID       =   ""
   CSSClasses      =   ""
   ...
   Begin WebRectangle Rectangle1
      ...
      Begin WebLabel lblAUC
         ...
         _mPanelIndex    =   -1
      End
      Begin WebPopupMenu popSecondaryOP
         ControlID       =   ""
         CSSClasses      =   ""
         Enabled         =   True
         Height          =   38
      ...
      Begin WebLabel lblSecondaryOP
         ...
         _mPanelIndex    =   -1
      End
      Begin WebPopupMenu popPrimaryCare
         ControlID       =   ""
         CSSClasses      =   ""
         Enabled         =   True
         Height          =   38
      ...
      Begin WebLabel lblPrimaryCare
         ...
         _mPanelIndex    =   -1
      End
      Begin WebPopupMenu popSecondaryIP
         ControlID       =   ""
         CSSClasses      =   ""
         Enabled         =   True
         Height          =   38
   ...
   Begin WebLabel lblContexts
      ...
      _mPanelIndex    =   -1
   End
   Begin WebCheckbox chkSourceEACVI
      Caption         =   "EACVI"
      ControlID       =   ""
      CSSClasses      =   ""
      Enabled         =   True
      ...
      _mPanelIndex    =   -1
   End
   Begin WebCheckbox chkSourceBSE
      Caption         =   "BSE"
      ControlID       =   ""
      CSSClasses      =   ""
      Enabled         =   True
      ...
      _mPanelIndex    =   -1
   End
   Begin WebCheckbox chkSourceASE
      Caption         =   "ASE"
      ControlID       =   ""
      CSSClasses      =   ""
      Enabled         =   True
      ...
      _mPanelIndex    =   -1
   End
   Begin WebCheckbox chkSourceConsensus
      Caption         =   "Consensus"
      ControlID       =   ""
      CSSClasses      =   ""
      Enabled         =   True
		...
		Private Sub LoadAvailableContexts()
		  ...
		  Try
		    ...
		    For Each ctx As Context In contexts
		      ...
		      lstContexts.CellCheckBoxValueAt(lstContexts.LastAddedRowIndex, 0) = False
		    Next
