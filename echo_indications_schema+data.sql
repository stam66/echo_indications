...
CREATE TABLE `users`( 
	...
	`password_salt` VarChar( 64 ) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'Random salt for password hashing',
	`password_iterations` Int( 11 ) NULL DEFAULT 10000 COMMENT 'Number of hash iterations (PBKDF2-like)',
...
CREATE TABLE `rate_limit`( 
	...
	`endpoint` VarChar( 50 ) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
...
INSERT INTO `users`(`id`,`username`,`password_hash`,`password_salt`,`password_iterations`,`email`,`is_active`,`created_at`,`updated_at`,`title`,`OTP`,`name`) VALUES 
( '1', 'admin', '5e9293d879732c749b3542f5d0fa6b47c6b96c852ef8162723bfe36ad88557c6', 'JOfhrVgRrIHdQNr7pOcx4e9c0nPCSKDW', '10000', 'stam66@mac.com', '1', '2025-11-29 01:22:57', '2026-01-22 16:52:59', 'System Admin', '0', 'Admin' ),
( '2', 'SKapetanakis', '5e9293d879732c749b3542f5d0fa6b47c6b96c852ef8162723bfe36ad88557c6', 'kDfjAwWJbx46WksoEuvgWF7tjsXFlV0C', '10000', 'skapetanakis@nhs.net', '1', '2025-12-10 03:33:16', '2026-01-22 16:54:53', 'ECHO Lead GSTT', '0', 'Stam Kapetanakis' ),
( '6', 'APapachristidis', NULL, NULL, '10000', 'alexandros.papachristidis@nhs.net', '1', '2025-12-22 19:57:51', '2025-12-22 20:04:50', 'ECHO Lead KCH', '0', 'Alexandros Papchristidis' ),
( '7', 'ABaltabaeva', NULL, NULL, '10000', 'a.baltabaeva@nhs.net', '1', '2025-12-22 20:00:23', '2025-12-22 20:04:43', 'ECHO lead HH', '0', 'Aigul Baltabaeva' ),
( '8', 'RKhattar', NULL, NULL, '10000', 'rajdeepsingh.khattar@nhs.net', '1', '2025-12-22 20:02:39', '2025-12-22 20:05:12', 'ECHO Lead RBH', '0', 'Rajdeep Singh Khattar' ),
( '9', 'NPapamichail', NULL, NULL, '10000', 'nikolaos.papamichail@nhs.net', '1', '2025-12-22 20:04:26', '2025-12-22 20:04:58', 'ECHO Lead LGT', '0', 'Nikolaos Papamichail' ),
( '10', 'Stam', '3c2c13d9b9dc37fe2d0b63d9f3e746484818ae29db5755930a6cb89c2e281e20', NULL, '10000', 'stam66@gmail.com', '1', '2026-01-22 17:21:40', '2026-01-22 17:22:58', 'Admin', '1', 'Stam Kapetanakis' );
COMMIT;
-- ---------------------------------------------------------
...
( '1', 'ACHD', 'Adult Congenital Heart Disease', '13', '1' ),
( '2', 'Arrhythmia', 'Cardiac rhythm disorders', '6', '1' ),
( '3', 'Arterial', 'Arterial conditions, aortic disease & hypertension', '8', '1' ),
( '4', 'Cardio-Oncology', 'Oncology-related indications', '4', '1' ),
( '5', 'Coronary', 'Coronary artery disease', '7', '1' ),
( '6', 'General', 'General indications', '9', '1' ),
( '7', 'ICC', 'Inherited Cardiac Conditions (eg DCM)', '10', '1' ),
( '8', 'Myocardial', 'Myocardial disease, heart failure', '3', '1' ),
( '9', 'Pericardial', 'Pericardial disease', '11', '1' ),
( '10', 'Systemic', 'Systemic conditions (sarcoid, amyloid etc)', '12', '1' ),
( '11', 'Valve', 'Valvular heart disease & endocarditis', '5', '1' ),
...
( '180', '2025-12-22 19:57:51', 'skapetanakis', 'users', '6', 'create', NULL, NULL, '{"name":"Alexandros Papchristidis","username":"apapachristidis","email":"alexandros.papachristidis@nhs.net","title":"ECHO Lead KCH","is_active":"1"}' ),
( '181', '2025-12-22 20:00:23', 'skapetanakis', 'users', '7', 'create', NULL, NULL, '{"name":"Aigul Baltabaeva","username":"abaltabaeva","email":"a.baltabaeva@nhs.net","title":"ECHO lead HH","is_active":"1"}' ),
( '182', '2025-12-22 20:02:39', 'skapetanakis', 'users', '8', 'create', NULL, NULL, '{"name":"Rajdeep Singh Khattar","username":"rkhattar","email":"rajdeepsingh.khattar@nhs.net","title":"ECHO Lead RBH","is_active":"1"}' ),
( '183', '2025-12-22 20:04:26', 'skapetanakis', 'users', '9', 'create', NULL, NULL, '{"name":"Nikolaos Papamichail","username":"npapamichail","email":"nikolaos.papamichail@nhs.net","title":"ECHO Lead LGT","is_active":"1"}' ),
( '184', '2025-12-23 00:38:11', 'skapetanakis', 'indications', '176', 'update', 'primary_care,secondary_inpatient,secondary_outpatient', '{"primary_care":"indicated","secondary_inpatient":"indicated","secondary_outpatient":"indicated"}', '{"primary_care":"not_indicated","secondary_inpatient":"can_be_considered","secondary_outpatient":"not_indicated"}' ),
( '185', '2025-12-23 00:40:45', 'skapetanakis', 'indications', '253', 'update', 'keywords,secondary_outpatient', '{"keywords":"AFL, atrial flutter","secondary_outpatient":"not_indicated"}', '{"keywords":"AF, atrial flutter, fibrillation","secondary_outpatient":"can_be_considered"}' ),
( '186', '2025-12-23 00:41:31', 'skapetanakis', 'indications', '253', 'update', 'keywords', '{"keywords":"AF, atrial flutter, fibrillation"}', '{"keywords":"PAF, AF, atrial flutter, fibrillation"}' ),
( '187', '2025-12-23 01:00:50', 'skapetanakis', 'indications', '222', 'update', 'keywords', '{"keywords":"aorta, aortic"}', '{"keywords":"aorta, aortic, dilated ascending aorta"}' ),
( '188', '2025-12-23 05:23:29', 'skapetanakis', 'indications', '167', 'update', 'keywords,primary_care', '{"keywords":"blackout, syncope","primary_care":"not_indicated"}', '{"keywords":"blackout, syncope, loss of consciousness","primary_care":"can_be_considered"}' ),
( '189', '2025-12-23 05:25:55', 'skapetanakis', 'indications', '271', 'update', 'keywords,secondary_outpatient', '{"keywords":"","secondary_outpatient":"not_indicated"}', '{"keywords":"SOB, dyspnoea, BNP","secondary_outpatient":"can_be_considered"}' ),
( '190', '2025-12-23 15:11:12', 'skapetanakis', 'contexts', '8', 'update', 'sort_order', '{"sort_order":10}', '{"sort_order":9}' ),
( '191', '2025-12-23 15:11:12', 'skapetanakis', 'contexts', '7', 'update', 'sort_order', '{"sort_order":9}', '{"sort_order":10}' ),
( '192', '2025-12-23 15:11:12', 'skapetanakis', 'contexts', '8', 'update', 'sort_order', '{"sort_order":9}', '{"sort_order":8}' ),
( '193', '2025-12-23 15:11:12', 'skapetanakis', 'contexts', '6', 'update', 'sort_order', '{"sort_order":8}', '{"sort_order":9}' ),
( '194', '2025-12-23 15:11:14', 'skapetanakis', 'contexts', '8', 'update', 'sort_order', '{"sort_order":8}', '{"sort_order":7}' ),
( '195', '2025-12-23 15:11:14', 'skapetanakis', 'contexts', '5', 'update', 'sort_order', '{"sort_order":7}', '{"sort_order":8}' ),
( '196', '2025-12-23 15:11:15', 'skapetanakis', 'contexts', '8', 'update', 'sort_order', '{"sort_order":7}', '{"sort_order":6}' ),
( '197', '2025-12-23 15:11:15', 'skapetanakis', 'contexts', '4', 'update', 'sort_order', '{"sort_order":6}', '{"sort_order":7}' ),
( '198', '2025-12-23 15:11:15', 'skapetanakis', 'contexts', '8', 'update', 'sort_order', '{"sort_order":6}', '{"sort_order":5}' ),
( '199', '2025-12-23 15:11:15', 'skapetanakis', 'contexts', '3', 'update', 'sort_order', '{"sort_order":5}', '{"sort_order":6}' ),
( '200', '2025-12-23 15:11:16', 'skapetanakis', 'contexts', '8', 'update', 'sort_order', '{"sort_order":5}', '{"sort_order":4}' ),
( '201', '2025-12-23 15:11:16', 'skapetanakis', 'contexts', '2', 'update', 'sort_order', '{"sort_order":4}', '{"sort_order":5}' ),
( '202', '2025-12-23 15:11:19', 'skapetanakis', 'contexts', '8', 'update', 'sort_order', '{"sort_order":4}', '{"sort_order":3}' ),
( '203', '2025-12-23 15:11:19', 'skapetanakis', 'contexts', '1', 'update', 'sort_order', '{"sort_order":3}', '{"sort_order":4}' ),
( '204', '2025-12-23 15:11:23', 'skapetanakis', 'contexts', '4', 'update', 'sort_order', '{"sort_order":7}', '{"sort_order":6}' ),
( '205', '2025-12-23 15:11:23', 'skapetanakis', 'contexts', '3', 'update', 'sort_order', '{"sort_order":6}', '{"sort_order":7}' ),
( '206', '2025-12-23 15:11:24', 'skapetanakis', 'contexts', '4', 'update', 'sort_order', '{"sort_order":6}', '{"sort_order":5}' ),
( '207', '2025-12-23 15:11:24', 'skapetanakis', 'contexts', '2', 'update', 'sort_order', '{"sort_order":5}', '{"sort_order":6}' ),
( '208', '2025-12-23 15:11:25', 'skapetanakis', 'contexts', '4', 'update', 'sort_order', '{"sort_order":5}', '{"sort_order":4}' ),
( '209', '2025-12-23 15:11:25', 'skapetanakis', 'contexts', '1', 'update', 'sort_order', '{"sort_order":4}', '{"sort_order":5}' ),
( '210', '2025-12-23 15:11:37', 'skapetanakis', 'contexts', '1', 'update', 'sort_order', '{"sort_order":5}', '{"sort_order":6}' ),
( '211', '2025-12-23 15:11:37', 'skapetanakis', 'contexts', '2', 'update', 'sort_order', '{"sort_order":6}', '{"sort_order":5}' ),
( '212', '2025-12-23 15:11:37', 'skapetanakis', 'contexts', '1', 'update', 'sort_order', '{"sort_order":6}', '{"sort_order":7}' ),
( '213', '2025-12-23 15:11:37', 'skapetanakis', 'contexts', '3', 'update', 'sort_order', '{"sort_order":7}', '{"sort_order":6}' ),
( '214', '2025-12-23 15:11:38', 'skapetanakis', 'contexts', '1', 'update', 'sort_order', '{"sort_order":7}', '{"sort_order":8}' ),
( '215', '2025-12-23 15:11:38', 'skapetanakis', 'contexts', '5', 'update', 'sort_order', '{"sort_order":8}', '{"sort_order":7}' ),
( '216', '2025-12-23 15:11:38', 'skapetanakis', 'contexts', '1', 'update', 'sort_order', '{"sort_order":8}', '{"sort_order":9}' ),
( '217', '2025-12-23 15:11:38', 'skapetanakis', 'contexts', '6', 'update', 'sort_order', '{"sort_order":9}', '{"sort_order":8}' ),
( '218', '2025-12-23 15:11:40', 'skapetanakis', 'contexts', '1', 'update', 'sort_order', '{"sort_order":9}', '{"sort_order":10}' ),
( '219', '2025-12-23 15:11:40', 'skapetanakis', 'contexts', '7', 'update', 'sort_order', '{"sort_order":10}', '{"sort_order":9}' ),
( '220', '2025-12-23 15:11:40', 'skapetanakis', 'contexts', '1', 'update', 'sort_order', '{"sort_order":10}', '{"sort_order":11}' ),
( '221', '2025-12-23 15:11:40', 'skapetanakis', 'contexts', '9', 'update', 'sort_order', '{"sort_order":11}', '{"sort_order":10}' ),
( '222', '2025-12-23 15:11:41', 'skapetanakis', 'contexts', '1', 'update', 'sort_order', '{"sort_order":11}', '{"sort_order":12}' ),
( '223', '2025-12-23 15:11:41', 'skapetanakis', 'contexts', '10', 'update', 'sort_order', '{"sort_order":12}', '{"sort_order":11}' ),
( '224', '2025-12-23 15:11:45', 'skapetanakis', 'contexts', '11', 'update', 'sort_order', '{"sort_order":13}', '{"sort_order":12}' ),
( '225', '2025-12-23 15:11:45', 'skapetanakis', 'contexts', '1', 'update', 'sort_order', '{"sort_order":12}', '{"sort_order":13}' ),
( '226', '2025-12-23 15:11:46', 'skapetanakis', 'contexts', '11', 'update', 'sort_order', '{"sort_order":12}', '{"sort_order":11}' ),
( '227', '2025-12-23 15:11:46', 'skapetanakis', 'contexts', '10', 'update', 'sort_order', '{"sort_order":11}', '{"sort_order":12}' ),
( '228', '2025-12-23 15:11:46', 'skapetanakis', 'contexts', '11', 'update', 'sort_order', '{"sort_order":11}', '{"sort_order":10}' ),
( '229', '2025-12-23 15:11:46', 'skapetanakis', 'contexts', '9', 'update', 'sort_order', '{"sort_order":10}', '{"sort_order":11}' ),
( '230', '2025-12-23 15:11:46', 'skapetanakis', 'contexts', '11', 'update', 'sort_order', '{"sort_order":10}', '{"sort_order":9}' ),
( '231', '2025-12-23 15:11:46', 'skapetanakis', 'contexts', '7', 'update', 'sort_order', '{"sort_order":9}', '{"sort_order":10}' ),
( '232', '2025-12-23 15:11:47', 'skapetanakis', 'contexts', '11', 'update', 'sort_order', '{"sort_order":9}', '{"sort_order":8}' ),
( '233', '2025-12-23 15:11:47', 'skapetanakis', 'contexts', '6', 'update', 'sort_order', '{"sort_order":8}', '{"sort_order":9}' ),
( '234', '2025-12-23 15:11:47', 'skapetanakis', 'contexts', '11', 'update', 'sort_order', '{"sort_order":8}', '{"sort_order":7}' ),
( '235', '2025-12-23 15:11:47', 'skapetanakis', 'contexts', '5', 'update', 'sort_order', '{"sort_order":7}', '{"sort_order":8}' ),
( '236', '2025-12-23 15:11:49', 'skapetanakis', 'contexts', '11', 'update', 'sort_order', '{"sort_order":7}', '{"sort_order":6}' ),
( '237', '2025-12-23 15:11:49', 'skapetanakis', 'contexts', '3', 'update', 'sort_order', '{"sort_order":6}', '{"sort_order":7}' ),
( '238', '2025-12-23 15:11:49', 'skapetanakis', 'contexts', '11', 'update', 'sort_order', '{"sort_order":6}', '{"sort_order":5}' ),
( '239', '2025-12-23 15:11:49', 'skapetanakis', 'contexts', '2', 'update', 'sort_order', '{"sort_order":5}', '{"sort_order":6}' ),
( '240', '2025-12-23 15:11:53', 'skapetanakis', 'contexts', '5', 'update', 'sort_order', '{"sort_order":8}', '{"sort_order":7}' ),
( '241', '2025-12-23 15:11:53', 'skapetanakis', 'contexts', '3', 'update', 'sort_order', '{"sort_order":7}', '{"sort_order":8}' ),
( '242', '2026-01-15 08:17:03', 'skapetanakis', 'indications', '158', 'update', 'keywords', '{"keywords":""}', '{"keywords":"LVH"}' ),
( '243', '2026-01-22 17:21:40', 'skapetanakis', 'users', '10', 'create', NULL, NULL, '{"name":"Stam Kapetanakis","username":"Stam","email":"stam66@gmail.com","title":"Admin","is_active":"1"}' );
COMMIT;
-- ---------------------------------------------------------
...
( '158', 'Initial investigation in patient with suspected hypertensive heart disease', 'LVH', '', 'indicated', 'indicated', 'indicated', '0', '0', '1', '1', '2025-12-20 12:47:07', '2026-01-15 08:17:03', 'soon' ),
...
( '167', 'Syncope with clinical suspicion of cardiac disease', 'blackout, syncope, loss of consciousness', '', 'can_be_considered', 'indicated', 'indicated', '0', '0', '1', '1', '2025-12-20 12:47:07', '2025-12-23 05:23:29', 'soon' ),
...
( '176', 'Murmur with no clinical suspicion of cardiovascular disease and benign family history under the age of 50y and with no previous ECHO.', 'family history, heart murmur, murmur', '', 'not_indicated', 'can_be_considered', 'not_indicated', '0', '0', '1', '1', '2025-12-20 12:47:07', '2025-12-23 00:48:30', 'can_be_considered' ),
...
( '183', 'Central cyanosis', '', '', 'indicated', 'indicated', 'indicated', '0', '0', '0', '1', '2025-12-20 12:47:07', '2025-12-23 05:45:14', 'soon' ),
...
( '222', 'Re-evaluation of known ascending aortic dilation or history of aortic dissection to establish a baseline rate of expansion or when the rate of expansion is excessive', 'aorta, aortic, dilated ascending aorta', '', 'not_indicated', 'indicated', 'indicated', '0', '1', '1', '1', '2025-12-20 12:47:07', '2025-12-23 01:00:50', 'soon' ),
...
( '253', 'Sustained or paroxysmal AF or atrial flutter without change in clinical status', 'PAF, AF, atrial flutter, fibrillation', '', 'not_indicated', 'not_indicated', 'can_be_considered', '0', '0', '1', '1', '2025-12-20 12:47:07', '2025-12-23 00:41:31', 'not_indicated' ),
...
( '271', 'Shortness of breath with normal NT-proBNP', 'SOB, dyspnoea, BNP', '', 'not_indicated', 'not_indicated', 'can_be_considered', '0', '0', '1', '1', '2025-12-20 12:47:07', '2025-12-23 05:25:55', 'can_be_considered' ),
...
( 'Change request for indication id 228', NULL, 'Closed', 'Arrhythmia', NULL, '7', 'Syncope with clinical suspicion of cardiac disease', 'Can you add Loss of consciousness? So that search is easy. Often GPs don\'t put syncope', '228', 'Resolved', '2025-12-22 02:10:04' ),
( 'Change request for indication id 228', NULL, 'Closed', 'Arrhythmia', NULL, '8', 'Syncope with clinical suspicion of cardiac disease', 'Can you add Loss of consciousness? So that search is easy. Often GPs don\'t put syncope', '228', 'Duplicate', '2025-12-22 02:10:04' ),
...
( 'Change request for indication id 314', NULL, 'Closed', 'Arrhythmia', NULL, '19', 'Sustained or paroxysmal AF or atrial flutter without change in clinical status', 'AF/atrial flutter', '314', 'Resolved', '2025-12-22 02:10:05' ),
( 'Change request for indication id 314', NULL, 'Closed', 'Arrhythmia', NULL, '20', 'Sustained or paroxysmal AF or atrial flutter without change in clinical status', 'AF/atrial flutter', '314', 'Duplicate', '2025-12-22 02:10:05' ),
( 'Change request for indication id 283', NULL, 'Closed', 'Arterial', NULL, '21', 'Re-evaluation of known ascending aortic dilation or history of aortic dissection to establish a baseline rate of expansion or when the rate of expansion is excessive', 'Dilated ascending aorta', '283', 'Resolved', '2025-12-22 02:10:05' ),
...
( 'Change request for indication id 237', NULL, 'Closed', 'Valve', NULL, '27', 'Murmur with no clinical suspicion of cardiovascular disease and benign family history under the age of 50y and with no previous ECHO.', '? is this needed for an inpatient if there are no symptoms ', '237', 'Duplicate', '2025-12-22 02:10:05' ),
( 'Change request for indication id 237', NULL, 'Closed', 'Valve', NULL, '28', 'Murmur with no clinical suspicion of cardiovascular disease and benign family history under the age of 50y and with no previous ECHO.', '? is this needed for an inpatient if there are no symptoms ', '237', 'Duplicate', '2025-12-22 02:10:05' ),
...
( 'Change request for indication id 237', NULL, 'Closed', 'Valve', NULL, '32', 'Murmur with no clinical suspicion of cardiovascular disease and benign family history under the age of 50y and with no previous ECHO.', '? should not be indicated', '237', 'Duplicate', '2025-12-22 02:10:05' ),
( 'Change request for indication id 237', NULL, 'Closed', 'Valve', NULL, '33', 'Murmur with no clinical suspicion of cardiovascular disease and benign family history under the age of 50y and with no previous ECHO.', '? should not be indicated', '237', 'Resolved', '2025-12-22 02:10:06' ),
...
CREATE INDEX `idx_users_username` USING BTREE ON `users`( `username` );
-- -------------------------------------------------------------
...
-- CREATE INDEX "idx_ip_endpoint" ------------------------------
CREATE INDEX `idx_ip_endpoint` USING BTREE ON `rate_limit`( `ip_address`, `endpoint` );
-- -------------------------------------------------------------


-- CREATE INDEX "idx_last_attempt" -----------------------------
CREATE INDEX `idx_last_attempt` USING BTREE ON `rate_limit`( `last_attempt` );
-- -------------------------------------------------------------


-- CREATE INDEX "idx_locked_until" -----------------------------
CREATE INDEX `idx_locked_until` USING BTREE ON `rate_limit`( `locked_until` );
-- -------------------------------------------------------------
