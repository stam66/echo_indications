#tag DesktopWindow
Begin DesktopContainer UsersContainer
...
#tag WindowCode
	#tag Constant, Name = kSectionTitle, Type = String, Dynamic = False, Default = \"Manage Admins", Scope = Public
	#tag EndConstant
