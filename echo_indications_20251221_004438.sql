...
( '1', 'ACHD', 'Adult Congenital Heart Disease', '0', '1' ),
( '2', 'Arrhythmia', 'Cardiac rhythm disorders', '0', '1' ),
( '3', 'Arterial', 'Arterial conditions, aortic disease & hypertension', '0', '1' ),
( '4', 'Cardio-Oncology', 'Oncology-related indications', '0', '1' ),
( '5', 'Coronary', 'Coronary artery disease', '0', '1' ),
( '6', 'General', 'General indications', '0', '1' ),
( '7', 'ICC', 'Inherited Cardiac Conditions (eg DCM)', '0', '1' ),
( '8', 'Myocardial', 'Myocardial disease, heart failure', '0', '1' ),
( '9', 'Pericardial', 'Pericardial disease', '0', '1' ),
( '10', 'Systemic', 'Systemic conditions (sarcoid, amyloid etc)', '0', '1' ),
( '11', 'Valve', 'Valvular heart disease & endocarditis', '0', '1' ),
( '12', 'PHTN & right heart', 'Pulmonary hypertension, right heart', '0', '1' ),
( '13', 'Primary Care', 'A context for locating indications relevant to primary care', '0', '0' ),
( '14', 'New', 'New indications for multi-hospital review', '0', '1' );
COMMIT;
-- ---------------------------------------------------------
...
( 'another request', 'SK', 'New', NULL, NULL, '2', NULL, NULL, NULL, '', '2025-12-18 02:16:12' );
COMMIT;
-- ---------------------------------------------------------
